      ...
      <div className="flex items-center justify-center w-full h-full relative z-10">
        ...
        {imgStatus !== 'error' && (
          <img 
            ...
            className={`max-w-[85%] max-h-[75%] object-contain transition-all duration-700 group-hover:scale-110 group-hover:rotate-2 filter drop-shadow-[0_8px_16px_rgba(0,0,0,0.08)] ${imgStatus === 'loaded' ? 'opacity-100 scale-100' : 'opacity-0 scale-95 absolute'}`}
          />
        )}
...
export default function ImportSection() {
  ...
  return (
    <section className="py-20 bg-white overflow-hidden border-y border-slate-100/50">
      <div className="container-shell text-center mb-14 px-4">
